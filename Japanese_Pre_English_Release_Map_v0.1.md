...
| 1997-12-15 | `jp_promo_corocoro_19971215` | CoroCoro Jan. 1998 issue | CoroCoro insert | Meowth, glossy Computer Error | Promo target | Exact issue mapping should be preserved; the current source-slice models Meowth and leaves glossy Computer Error as a source gap rather than reusing the later Kamex print row. |
...
| 1998-02-10 to 1998-07-31 | `jp_promo_trade_please_199802` | Trade Please Campaign | Mail/campaign exchange | Venusaur, Charizard, Blastoise, Trade Please! | Promo target | Current source-slice models all four card identities; campaign flyer, return-envelope, fulfillment, and copy-count claims stay outside row authority. |
...
| 1998-05 | `jp_promo_garura_parent_child_199805` | Garura Parent/Child Tournament | Tournament participation/winner prizes | Touch Change!, Kangaskhan | Promo target | Current source-slice models the two tournament card identities; copy counts, rules-packet details, prize thresholds, and Touch Change! reprint census stay outside row authority. |
...
| 1998-07 to 1998-08 | `jp_promo_kamex_mega_battle_199807` | Kamex Mega Battle | Tournament participation/prizes | Computer Error, No.1 Trainer, No.2 Trainer, No.3 Trainer | Promo target | Current source-slice models the four regional participation/placement card identities and the Computer Error non-glossy white-shadow distinction; copy counts, venue schedule, winner ledger, trophy plaques, side events, national finals, and complete Computer Error variant census stay outside row authority. |
