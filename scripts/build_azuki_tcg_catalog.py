...
USER_PROMO_PHOTO_OBSERVATIONS = [
    ...
    },
    {
        ...
        "OBSERVATION_NOTE": "User explicitly confirms the pictured card as real. The photo visibly shows Serene Fist, Misaki STT02-008, a gold WINNER treatment, star-marked UC line, and an illustrator credit that appears to read Aflorane. The live official API on 2026-07-10 lists only base UC Misaki, so this remains a distinct user-observed winner treatment; authenticity is user-asserted rather than independently verified.",
    },
]
