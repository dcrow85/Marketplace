...
PORTRAIT_ALT_OBSERVATION_ID = "azuki_tcg_user_image_portrait_alt_observations_2026_06_24"
...
USER_PROMO_PHOTO_SOURCES = {
    ...
    "misaki-winner-20260710": {
        "kind": "user_provided_photo",
        "date": "2026-07-10",
        "sha256": "fd3015cfddfa4ced7f1f3cbb55e2e7618ee92c817906ababd9ff8879cdc15705",
        "stored_in_repo": True,
        "public_path": "assets/observations/serene-fist-misaki-tournament-winner-2026-07-10.png",
        "repo_path": "web/public/assets/observations/serene-fist-misaki-tournament-winner-2026-07-10.png",
        "official_gallery_check": {
            "checked": "2026-07-10",
            "url": API_URL,
            "api_count": 237,
            "matching_source_entry_ids": ["S1-STT02-008_Serene-Fist-Misaki_E_UC_die"],
            "winner_treatment_enumerated": False,
        },
        "note": "The user supplied this photo for catalogue display and explicitly confirmed the pictured card as real. That authenticity status is retained as a user assertion, not independent verification by the image, model, catalogue, or official gallery.",
    },
    "shao-perseverance-ax-winner-20260710": {
        "kind": "user_provided_photo",
        "date": "2026-07-10",
        "sha256": "2d5db4a0d5145269806f9ed44b0e1c31662dd099a3e53f0fe042892bbf3f4649",
        "stored_in_repo": True,
        "public_path": "assets/observations/shaos-perseverance-anime-expo-2026-winner.png",
        "repo_path": "web/public/assets/observations/shaos-perseverance-anime-expo-2026-winner.png",
        "official_gallery_check": {
            "checked": "2026-07-10",
            "url": API_URL,
            "api_count": 237,
            "matching_source_entry_ids": [
                "S1-STT02-017_Shaos-Perseverance_S_SR_die",
                "STT02-017A_Shaos-Perseverance_S_SR_die"
            ],
            "anime_expo_winner_treatment_enumerated": False,
        },
        "official_event_context": {
            "event": "Anime Expo 2026",
            "url": "https://tcg.azuki.com/blog/019f1597-e79c-7cce-bbd4-5508892e6c8f",
            "officially_named_promo": True,
            "exact_award_activity_identified": False,
        },
        "note": "The user supplied this real-card photo and says the card was given out at Anime Expo. The visible AX WINNER / ANIME EXPO 2026 EXCLUSIVE treatment and official event page support event association; the exact demo, Starter Deck Battle, match, recipient, and quantity remain unresolved.",
    },
    "lady-emberheart-winner-20260710": {
        "kind": "user_provided_photo",
        "date": "2026-07-10",
        "sha256": "49102cc3eabd412bb85903c700d4b2b1de6af70e9ffac38d2416929bee2b2638",
        "stored_in_repo": True,
        "public_path": "assets/observations/lady-emberheart-winner-2026-07-10.png",
        "repo_path": "web/public/assets/observations/lady-emberheart-winner-2026-07-10.png",
        "official_gallery_check": {
            "checked": "2026-07-10",
            "url": API_URL,
            "api_count": 237,
    ...
    "black-jade-crewleader-winner-20260716": {
        "kind": "user_provided_photo",
        "date": "2026-07-16",
        "sha256": "812863a58d10eee2233697ccf970e9206adebe9ab3741ec68cebe729318352cd",
        "stored_in_repo": True,
        "public_path": "assets/observations/black-jade-crewleader-winner-2026-07-16.png",
        "repo_path": "web/public/assets/observations/black-jade-crewleader-winner-2026-07-16.png",
        "official_gallery_check": {
            "checked": "2026-07-16",
            "url": API_URL,
            "api_count": 237,
            "matching_source_entry_ids": ["S1-STT01-008_Black-Jade-Crewleader_E_UC_die"],
            "winner_treatment_enumerated": False,
        },
        "note": "The user supplied this Black Jade Crewleader WINNER card-front photo specifically for catalogue inclusion. It is user-photo observation evidence, not proof of authenticity, tournament origin, recipient, condition, possession, or value.",
    },
}
...
USER_PROMO_PHOTO_OBSERVATIONS = [
    ...
    {
        "SOURCE_KEY": "misaki-winner-20260710",
        "OBSERVATION_ID": "tournament-winner-photo-20260710-002",
        "ID": "STT02-008",
        "PRINTED_ID": "STT02-008",
        "NORMALIZED_CARD_ID": "STT02-008",
        "IKZ COST": "2",
        ...
        "REF_ID2": "",
        "RARITY": "UC ★",
        "ILLUSTRATOR": "Aflorane",
        "E_1": "",
        "E_1_TEXT": "This card cannot take damage from card effects.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "",
        ...
        "OBSERVED_STAMP": "WINNER visual stamp",
        "MATCHED_GALLERY_UIDS": [
            "azuki_tcg_official_gallery:S1-STT02-008_Serene-Fist-Misaki_E_UC_die",
        ],
        "DISPLAY_AS_DISTINCT_ROW": "true",
        "USER_ASSERTED_AUTHENTICITY": "confirmed_real",
        "AUTHENTICITY_AUTHORITY": "user_assertion",
        "OBSERVATION_CONFIDENCE": "high_for_visible_print_fields; medium_for_illustrator_transcription; user_confirmed_physical_authenticity",
        "OBSERVATION_NOTE": "User explicitly confirms the pictured card as real. The photo visibly shows Serene Fist, Misaki STT02-008, a gold WINNER treatment and star-marked UC line. Its Aflorane credit spelling is corroborated by the clearer Lady Emberheart WINNER photo. The live official API on 2026-07-10 lists only base UC Misaki, so this remains a distinct user-observed winner treatment; authenticity is user-asserted rather than independently verified.",
    },
    {
        "SOURCE_KEY": "shao-perseverance-ax-winner-20260710",
        "OBSERVATION_ID": "anime-expo-winner-photo-20260710-001",
        "ID": "STT02-017",
        "PRINTED_ID": "STT02-017",
        "NORMALIZED_CARD_ID": "STT02-017",
        "IKZ COST": "6",
        "NAME": "Shao's Perseverance",
        "ELEMENT": "Water",
        "TYPE": "Spell",
        "SUBTYPE_1": "Shao",
        "SUBTYPE_2": "Watercrafting",
        "SUBTYPE_3": "",
        "GATE_PWR": "",
        "ATK": "",
        "HP": "",
        ...
        "REF_ID2": "",
        "RARITY": "SR",
        "ILLUSTRATOR": "Pandart Studio",
        "E_1": "Main",
        "E_1_TEXT": "If your leader is Shao, return all entities with a cost of 4 or less in your opponent's Garden to their owner's hand.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "Spell cards don't enter the field. They resolve, then go to the discard pile.",
        "RULING_TEXT": "",
        "STAMP": "AX WINNER · ANIME EXPO 2026 EXCLUSIVE",
        "IMG": "",
        "ALT_IMG": "",
        "PHYSICAL_LOCATION_IN_IMAGE": "single_card_front",
        "OBSERVED_AZUKI_NUMBER": "Azuki #187",
        "OBSERVED_STAMP": "AX WINNER · ANIME EXPO 2026 EXCLUSIVE",
        "MATCHED_GALLERY_UIDS": [
            "azuki_tcg_official_gallery:S1-STT02-017_Shaos-Perseverance_S_SR_die",
            "azuki_tcg_official_gallery:STT02-017A_Shaos-Perseverance_S_SR_die"
        ],
        "DISPLAY_AS_DISTINCT_ROW": "true",
        "OBSERVED_VARIANT_KIND": "user_observed_anime_expo_winner_treatment",
        "OBSERVED_FOIL_TREATMENT": "true",
        "USER_ASSERTED_AUTHENTICITY": "confirmed_real",
        "AUTHENTICITY_AUTHORITY": "user_assertion",
        "OBSERVED_EVENT": "Anime Expo 2026",
        "EVENT_DISTRIBUTION": "given_out_at_event_exact_activity_unresolved",
        "EVENT_AUTHORITY": "user_assertion_plus_visible_event_stamp_plus_official_event_context",
        "OFFICIAL_EVENT_SOURCE_URL": "https://tcg.azuki.com/blog/019f1597-e79c-7cce-bbd4-5508892e6c8f",
        "OBSERVATION_CONFIDENCE": "high_for_visible_print_fields_and_event_stamp; user_confirmed_physical_authenticity_and_event_distribution",
        "OBSERVATION_NOTE": "User confirms this as a real card given out at Anime Expo. The photo visibly identifies Shao's Perseverance STT02-017 and carries AX WINNER / ANIME EXPO 2026 EXCLUSIVE marks. Azuki's official event page names stamped full-art Shao's Perseverance as an AX promo and describes both demo chances and Starter Deck Battles for AX cards, but does not identify the exact activity that awarded this WINNER treatment.",
    },
    {
        "SOURCE_KEY": "lady-emberheart-winner-20260710",
        "OBSERVATION_ID": "tournament-winner-photo-20260710-003",
        "ID": "STT04-008",
        "PRINTED_ID": "STT04-008",
        "NORMALIZED_CARD_ID": "STT04-008",
        "IKZ COST": "3",
        "NAME": "Lady Emberheart",
        "ELEMENT": "Fire",
        "TYPE": "Entity",
        "SUBTYPE_1": "Crimsondrift",
        "SUBTYPE_2": "",
        "SUBTYPE_3": "",
        "GATE_PWR": "0",
        "ATK": "2",
        ...
        "ILLUSTRATOR": "Aflorane",
        "E_1": "Once/Turn",
        "E_1_TEXT": "On your turn, after this card attacks an entity, you may untap this card.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "",
        ...
        "IMG": "",
        "ALT_IMG": "",
        "PHYSICAL_LOCATION_IN_IMAGE": "single_card_front_in_sleeve",
        "OBSERVED_AZUKI_NUMBER": "",
        "OBSERVED_STAMP": "WINNER visual stamp",
        "MATCHED_GALLERY_UIDS": [
            "azuki_tcg_official_gallery:S1-STT04-008_Lady-Emberheart_E_UC_die"
        ],
        "DISPLAY_AS_DISTINCT_ROW": "true",
    ...
    {
        "SOURCE_KEY": "black-jade-crewleader-winner-20260716",
        "OBSERVATION_ID": "tournament-winner-photo-20260716-004",
        "ID": "STT01-008",
        "PRINTED_ID": "STT01-008",
        "NORMALIZED_CARD_ID": "STT01-008",
        "IKZ COST": "3",
        "NAME": "Black Jade Crewleader",
        "ELEMENT": "Lightning",
        "TYPE": "Entity",
        "SUBTYPE_1": "Black Jade",
        "SUBTYPE_2": "Steelborn",
        "SUBTYPE_3": "",
        "GATE_PWR": "1",
        "ATK": "2",
        ...
        "REF_ID2": "",
        "RARITY": "UC ★",
        "ILLUSTRATOR": "Twisted Hand Studio",
        "E_1": "",
        "E_1_TEXT": "When equipped with a Weapon card, this card has +1 attack.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "",
        ...
        "ALT_IMG": "",
        "PHYSICAL_LOCATION_IN_IMAGE": "single_card_front",
        "OBSERVED_AZUKI_NUMBER": "Azuki #4",
        "OBSERVED_STAMP": "WINNER visual stamp",
        "MATCHED_GALLERY_UIDS": [
            "azuki_tcg_official_gallery:S1-STT01-008_Black-Jade-Crewleader_E_UC_die"
        ],
        "DISPLAY_AS_DISTINCT_ROW": "true",
        "OBSERVED_VARIANT_KIND": "user_observed_winner_treatment",
        "OBSERVED_FOIL_TREATMENT": "true",
        "OBSERVATION_CONFIDENCE": "high_for_visible_print_fields",
        "OBSERVATION_NOTE": "User-supplied card-front photo visibly shows Black Jade Crewleader STT01-008, a reflective star-marked UC treatment, large gold WINNER stamp, Azuki #4, and a TwistedHandStudio illustrator line. The 2026-07-16 official gallery snapshot lists the base UC card but does not enumerate this WINNER treatment. No event, tournament, authenticity, recipient, condition, possession, or value claim is made.",
    },
]

USER_PORTRAIT_ALT_IMAGE_SOURCES = {
    "zero": {
        "kind": "user_provided_image",
        "date": "2026-06-24",
        "sha256": "dfbf7caf3dc3ea0a02a078e883607d4f5b5af584541c8879ac878a8e2a70a38b",
        "stored_in_repo": False,
        "note": "The source image was provided in-session and is not committed to the public repository. The hash anchors the observation without publishing the card image.",
    },
    "shao": {
        "kind": "user_provided_image",
        "date": "2026-06-24",
        "sha256": "15bd740904d593e33fdc41ad305a707f93fccac407ea47a402e0cc2e40bab958",
        "stored_in_repo": False,
        "note": "The source image was provided in-session and is not committed to the public repository. The hash anchors the observation without publishing the card image.",
    },
}

USER_PORTRAIT_ALT_IMAGE_OBSERVATIONS = [
    {
        "OBSERVATION_ID": "portrait-alt-image-20260624-001",
        "ID": "STT04-001",
        "PRINTED_ID": "STT04-001",
        "NORMALIZED_CARD_ID": "STT04-01",
        "SOURCE_KEY": "zero",
        "IKZ COST": "",
        "NAME": "Zero",
        "ELEMENT": "Fire",
        ...
        "REF_ID2": "",
        "RARITY": "L ★",
        "ILLUSTRATOR": "steamboy",
        "E_1": "Once/Turn; Main",
        "E_1_TEXT": "Deal 1 damage to this card: Deal 1 damage to an entity in your Garden or Alley, then give that entity +1 attack until the end of the turn.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "",
        "RULING_TEXT": "",
        "STAMP": "portrait alternate rare image observation",
        "IMG": "",
        "ALT_IMG": "",
        "PHYSICAL_LOCATION_IN_IMAGE": "single_card_image_zero",
    ...
    },
    {
        ...
        "ID": "STT02-001",
        "PRINTED_ID": "STT02-001",
        "NORMALIZED_CARD_ID": "STT02-001",
        "SOURCE_KEY": "shao",
        "IKZ COST": "",
        "NAME": "Shao",
        "ELEMENT": "Water",
        ...
        "RARITY": "L ★",
        "ILLUSTRATOR": "steamboy",
        "E_1": "Once/Turn; Response",
        "E_1_TEXT": "1 IKZ: Reduce a leader's or an entity's attack by 1 until the end of the turn.",
        "E_2": "",
        "E_2_TEXT": "",
        "F_TEXT": "",
        "DEFINITION_TEXT": "",
        ...
        "IMG": "",
        "ALT_IMG": "",
        "PHYSICAL_LOCATION_IN_IMAGE": "single_card_image_shao",
        "OBSERVED_AZUKI_NUMBER": "Azuki #187",
        "OBSERVED_STAMP": "star leader portrait treatment",
        "MATCHED_GALLERY_UIDS": [
            "azuki_tcg_official_gallery:STT02-001A_Shao_L_AA_Die",
        ],
        "OBSERVATION_CONFIDENCE": "high",
        "OBSERVATION_NOTE": "Image reads printed STT02-001, L ★, Illus. steamboy, Azuki #187. Matched to the official gallery portrait alternate-art booster row.",
    },
]
...
def build_portrait_alt_observations(gallery_release: dict[str, Any]) -> tuple[str, dict[str, Any]]:
    gallery_uids = {card["uid"] for card in gallery_release["cards"]}
    rows: list[dict[str, Any]] = []
    for observation in USER_PORTRAIT_ALT_IMAGE_OBSERVATIONS:
        source = USER_PORTRAIT_ALT_IMAGE_SOURCES[observation["SOURCE_KEY"]]
        row = dict(observation)
        row["MATCHED_GALLERY_UIDS"] = "; ".join(row.get("MATCHED_GALLERY_UIDS") or [])
        row["SOURCE_IMAGE_SHA256"] = source["sha256"]
        row["SOURCE_IMAGE_STORED"] = str(source["stored_in_repo"]).lower()
        row["AUTHORITY_LABEL"] = "user_image_observation_not_official_gallery_fact"
        rows.append(row)
    ...
    printed_id_shape_discrepancies = [
        {
            "observation_id": observation["OBSERVATION_ID"],
            "printed_id": observation["PRINTED_ID"],
            "normalized_card_id": observation["NORMALIZED_CARD_ID"],
            "disposition": "preserve_printed_id_and_gallery_normalized_id_separately",
        }
        for observation in USER_PORTRAIT_ALT_IMAGE_OBSERVATIONS
        if observation["PRINTED_ID"] != observation["NORMALIZED_CARD_ID"]
    ]
    provenance = {
        "schema": "azuki_tcg_portrait_alt_observation_provenance_v0.1",
        "name": "Azuki TCG User Image Portrait Alt Observations",
        "csv_path": f"data/azuki-tcg/observations/{PORTRAIT_ALT_OBSERVATION_ID}.csv",
        "sources": USER_PORTRAIT_ALT_IMAGE_SOURCES,
        "row_count": len(rows),
        "counts": {
            "rows": len(rows),
            "unique_observation_ids": len({row["OBSERVATION_ID"] for row in rows}),
            "observed_cards_not_in_gallery_snapshot": len(not_in_gallery),
            "source_conflicts": 0,
            "printed_id_shape_discrepancies": len(printed_id_shape_discrepancies),
        },
        "observed_cards_not_in_gallery_snapshot": not_in_gallery,
        "printed_id_shape_discrepancies": printed_id_shape_discrepancies,
        "checks": {
            "all_observations_have_printed_id": all(row["PRINTED_ID"] for row in rows),
            "all_observations_have_authority_label": all(row["AUTHORITY_LABEL"] for row in rows),
            "matched_gallery_uids_exist": not missing_gallery_matches,
            "source_images_not_committed": all(
                source["stored_in_repo"] is False
                for source in USER_PORTRAIT_ALT_IMAGE_SOURCES.values()
            ),
        },
        "not_claiming": [
            "market value",
            "seller possession beyond the user-provided images",
            "physical authenticity or condition",
            "that the user images should overwrite linked sheet or gallery fields",
            "that a shared card ID proves identical physical printing across variants",
        ],
    }
    return text, provenance
...
def main() -> None:
    ...
    portrait_alt_observations_csv, portrait_alt_observations_provenance = build_portrait_alt_observations(release)
    ...
    portrait_alt_observations_csv_sha = sha256_text(portrait_alt_observations_csv)
    portrait_alt_observations_provenance_sha = sha256_text(canonical_json(portrait_alt_observations_provenance))
    snapshot_date = snapshot_path.stem.replace("cards_api_", "")
    alpha_source = {
    ...
    manifest = {
        ...
        "artifacts": {
            ...
            "portrait_alt_observations_csv": {
                "path": f"data/azuki-tcg/observations/{PORTRAIT_ALT_OBSERVATION_ID}.csv",
                "sha256": portrait_alt_observations_csv_sha,
            },
            "portrait_alt_observations_provenance": {
                "path": f"data/azuki-tcg/observations/{PORTRAIT_ALT_OBSERVATION_ID}_provenance.json",
                "sha256": portrait_alt_observations_provenance_sha,
            },
        },
        "counts": {
            ...
            "portrait_alt_observations": portrait_alt_observations_provenance["counts"],
        },
    ...
    portrait_alt_observation_checks = portrait_alt_observations_provenance["checks"]
    portrait_alt_observations_passed = all(portrait_alt_observation_checks.values())
    sources_passed = gallery_audit["passed"] and alpha_audit["passed"]
    audit = {
        "schema": "azuki_tcg_catalog_audit_v0.2",
        "passed": sources_passed and completion_passed and promo_observations_passed and portrait_alt_observations_passed,
        "status": "azuki_sources_imported_with_disclosed_residuals"
        if sources_passed and completion_passed and promo_observations_passed and portrait_alt_observations_passed
        ...
        "checks": {
            ...
            "portrait_alt_observations": portrait_alt_observation_checks,
        },
    ...
    json_targets = {
        ...
        OBSERVATION_DIR / f"{PORTRAIT_ALT_OBSERVATION_ID}_provenance.json": portrait_alt_observations_provenance,
    }
    text_targets = {
        ...
        OBSERVATION_DIR / f"{PORTRAIT_ALT_OBSERVATION_ID}.csv": portrait_alt_observations_csv,
    }
