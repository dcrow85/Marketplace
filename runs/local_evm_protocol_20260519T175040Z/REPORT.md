# Local EVM Protocol Probe: local_evm_protocol_20260519T175040Z
...
- Transactions:
  ...
  - `attach item evidence`: `0x60de2ce57ee238e14f4fcf681001170dcad15ab05d0250f16ab2dd91b817e820`
  - `approve verifier review scope`: `0xb87b80414d86f02ff3b30d5d504bc782907f7ac4b493addab7ec972ac3e40304`
  - `commit scoped verifier review`: `0x88abb56378219263b476b3465adf96da2b1f151d81160a7fed95c634113b6d51`
  - `commit item fingerprint`: `0x157c9a9e44c222e6b30ed179b99a5fbe4078c49a2d3cc2b4bee6a2d5c54c0597`
  - `commit inventory lock`: `0x7fd1110e8a37aa50c303ecb9a044b1b0abcb66ec74147c68eb96c52802d5c317`
  - `commit insured route`: `0xddb597ee278b783ce7b134938eef0112b4925049f3000db7321bc0b1846da4dd`
  - `mark route in progress`: `0xcbd5519a01a3dd251093f6638eecccae89db7f4349d4890f805b8bf52d37ff82`
  - `mark delivered`: `0x68570c11c6dcb9da94442689698581feb45a8773b647cc045db0e11f1a2c155c`
  - `buyer accepts`: `0x9c41b27d6561eafcd16d206cbf91afcfe9588b521cde692edff27489a6bb8f85`
- Anchored packets:
  ...
  - `happy_verifier_review` `0xe9bf53f05c78b8927e9234aada065047a82d6d36de3e45514d9d29cb4f556266` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  ...
  - `happy_route_spendability` `0x9bb2d213b655317ed127d1f87fcba3c041e31f532e980e3c3d04287fcb393de4` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create new-seller trade`: `0xc4af783a918a66b274d1876b50aad97d76435ec172c45113ca4b0baa1718e23f`
  - `seller posts larger bond`: `0x1ba9cac3bdd79d8da58bc1616a06656ba577f748c59a92783da8c20db4373f7c`
  - `attach weak proof`: `0xdd821228e35e567ee1c62f6089f6e1d9a35309c721d43b99cd29e8bb028d5614`
  - `accept claim seller predicate hash`: `0x3684a0d838e5286bd2e418e4fa467477c70cdb3c26a7453eed2d7ac758ec723f`
  - `attach seller activity predicate`: `0xd6f312d4e33ae7a5b25c568b071cd48afe63fc2a85923d929008d0b115a7cf4c`
  - `attach circuit profile hook`: `0xa64a5f6aa64317e53d5dfd912e4dac37d88c3b02ee0d77204a98b43bf9683615`
  - `approve claim verifier scope`: `0x9840c7dd91a3359ed8c8abee62bcc712ef0d3bc0522df492992f0bc0f69b863a`
  - `attach sparse evidence`: `0x87dbec438230dbf4cd4b2edc3c73aacef55691b7b8197c406e7c5afc7e2a64d7`
  - `commit claim item fingerprint`: `0x00cc83e7afa5e5b0f06edadd71c144bfb9a755cdf780e1ac2a94e217eb734c99`
  - `commit claim inventory lock`: `0xcc274add3cd9ea254226fe7489f785c184cd9abce923382c5df7abe237ddd428`
  - `open fingerprint challenge`: `0xcbb575519e7fe7a2446a52cda979c90c4815d33fcd9f98fe984353a4872afd81`
  - `clear fingerprint challenge`: `0x84ed81f3ec214d2444ea99c72b9810f7c94f2c7ebf27576c4dc2ae51416155e8`
  - `commit uninsured route`: `0xd3f6bba95baaac382fae3d08d7d8524e3e225df818f700d0b902911f70884aa0`
  - `mark delivered`: `0xdd77ffd7f0aa1a27f1ef5ee0640045e7d2ff6b9313d8c691ae51e379efe828c5`
  - `attach received-item claim evidence`: `0x9870f27f8734f847a4d1dc8e0d2e123897986abfb76c8bd1c3cd873699c0373f`
  - `commit verifier claim note`: `0x9a1ca6278f45f818dfd66d39da648a7f7759011cd9ad616b6e38caebfb87d083`
  - `open claim with buyer dispute bond`: `0xa0a15f85184c4613488b1d5e95e6228630162a7aead822e9632731621832b0e2`
  - `arbiter resolves claim`: `0x7000160c8f5e8b875553ffaeecf629f4dcdb15f5e2a6d2573eac15c956e05769`
- Anchored packets:
  ...
  - `claim_verifier_note` `0x2462592caa0518b51e9127ff3ae59e376fd6c26d6f26085d289c8803d4a82829` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  - `claim_challenge_clearance_spendability` `0x7105943d13c02bd2f47391f66f234b9869c5aa406dc1cf0566e48157e4e8108e` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_route_spendability` `0xd080216764f4f3cf55c826355ef1fc51fbea202fc3564ba2aedd740f207b88fa` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_support_spendability` `0x8b7ce2e317541b55629be38bc2a57b1b51a4207c827334b86a5963becc5ed955` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_bond_action_spendability` `0x945baae070ab9dd4541c4c6072d84d340076aef614e973dfc3075d6476fcdc87` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create replacement-path trade`: `0x0e760204acf3fdfd66811cf3f2dd9750ce3e0d64231ffc4e668fa9215ea7d834`
  - `seller posts replacement-path bond`: `0x922c5deb5bc7a78f26a6220c0802623f6f1b175962bfc233834d4efabb8bcc01`
  - `commit replacement-path item fingerprint`: `0xda1571196d97f1b01850943d9ab51ef555e94a77b719d2876ce9395fc1abbc38`
  - `commit replacement-path inventory lock`: `0xb804596509ff1494aa176b61a27872ff900c21df6567ce4745d57d0ee6c99a6a`
  - `commit replacement-path route`: `0xf70126bb8a4a0efea26c6b25497e4d2dc3951867b87f9f82dbf49084687a1f46`
  - `mark replacement-path delivered`: `0x31bb2977aa8e8d5e624b18fb5066541770a95bdfd30d444dc4cbdff266aed82f`
