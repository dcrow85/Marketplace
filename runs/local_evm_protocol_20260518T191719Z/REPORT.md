# Local EVM Protocol Probe: local_evm_protocol_20260518T191719Z
...
- Final state: `Settled`
- Transactions:
  - `create insured trade`: `0xca5a3855eda8fdde25ac1476950b2a369dbafe14b2f359b67036c1d8d0fe7e72`
  - `seller posts bond`: `0xdb5e34f9cf8cfd783ed237873465d023e550e29aac1304c3c2c83bc00b7438c7`
  - `attach trust proof`: `0x7d2bd11f08596b9150d78e483984649fd6c9f953ace2c9dfc01ff530d031cb01`
  - `accept seller private predicate hash`: `0xd9037fab65b07f968695b77d865ef962d8f5dc4b9499c1b9505ec7a06d317476`
  - `attach seller private predicate`: `0x79c0c352edb9970f4a62fcba4944558da4a307b5d1b24cfa31769e350ac1b9ce`
  - `accept buyer funding predicate hash`: `0xf73eddaa0e6f90d2f36b418641f18f61c9879aaa0982b075efc464e2e75f5c1d`
  - `attach buyer funding predicate`: `0x09ca0e7bce07a63fc9c50b8a882d77bb0362d6e8c61cdbf55ebb8f848678c5fc`
  - `attach item evidence`: `0x6f008809b9f359191202868d275afed8127e9f4ae3d1d9d7cf50165ec6dfd7b7`
  - `attach verifier review`: `0xb78db4ab1317f7cbe0cc72f14e417c7025305e14a687ef97907d4448d5b73ee8`
  - `commit insured route`: `0x7b964bcc86600dd73a1745b71fa076bad91a1ac243721487fd18b71eacc99620`
  - `mark route in progress`: `0x49e1ba8b324742a2c83754863ebadda9f255b9662fb0d5f149759c2f2383ca5c`
  - `mark delivered`: `0x7676493243366abb7c759ff85638f023f7051d02b1eb012f021ce931577b9500`
  - `buyer accepts`: `0xc326bed4ea3acdbf5283640f17305920f67a9437476fa3a931997aae31f9870a`
- Anchored packets:
...
- Observations:
  - replay item evidence reverted as expected (command failed (1): cast send 0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e attachEvidence(uint256,uint8,bytes32,bytes) 1 0 0x0e350f22a79e4b49d140ee4c009f3da94c010099c4bb4492f197924066c4061a 0x6202b9738fa767c1e5eb32e3c98291460098fc67fff6cfafdb252ada16d947be2703f5c6b6bdc43bc86e09b8cf14f93efc65256ad4e0637589cb9c3224bb96231b --rpc-url http://127.0.0.1:18545 --private-key 0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d --json).
...
- Final state: `Settled`
- Transactions:
  - `create new-seller trade`: `0x907ede8dd738ff1fc31487319bfdf35bac7245beb3ad249acb5646c0e35cb682`
  - `seller posts larger bond`: `0xcfb50268fd350c3d73c9c84253a8f91a620745b0ee4fd95061313961eb978d08`
  - `attach weak proof`: `0xa7d670de383449dff0688a4742691660fc897ceba3e2ccb534b956278796db56`
  - `accept claim seller predicate hash`: `0x3f3cb23d91e43ed56bbbc615fd7dd099bdc47b5a24706fb8cf79ebd05c6e912b`
  - `attach seller activity predicate`: `0xdc314a6a2c7ca2b5ce672470f842a6c102d73ba519fbcf518ca9b4369c2b5d36`
  - `attach circuit profile hook`: `0x5ea72817b614e5494e59e43d612def7cdd8abdfc574b97b2e5b615fe235b9c54`
  - `attach sparse evidence`: `0x68e0630eb62f2bb3e61851fc988301611a7243b19b0a4dfe243eef421e2e19a8`
  - `commit uninsured route`: `0x719d3a2ef5fb5101357cd5630857a4be86547012f0b0585046bafc6aef1db3fe`
  - `mark delivered`: `0x395d577271e1dad10dde1a05c9b4c83d16f717722fb7692bf82ea6285f871205`
  - `attach received-item claim evidence`: `0x88962693b872c76408ce9d4281840d907cbf94dee321c2506b39f8e47b52317b`
  - `attach verifier claim note`: `0x8db94b4f3f61e8f8c08c445fb2ebad267759a04a7e4e644c23f13457c8e74183`
  - `open claim with buyer dispute bond`: `0x8d05d9e6640c4266bf244a9aaa6b3916e1fdf47201e98e19147bfcf583d44533`
  - `arbiter resolves claim`: `0x343d9bbeb1bd5c13c7740e25f17a12c3bd0d1eba03514e59f5a780fc24426d8d`
- Anchored packets:
...
- Final state: `Settled`
- Transactions:
  - `create replacement-path trade`: `0x9d092077cfd3800ab0b21ee900498a53e121a476650a610e935d29bf1fd3c871`
  - `seller posts replacement-path bond`: `0xea5691523544195525bc658005f582b0dc738d2fe534d5f6949dec98e511bf6c`
  - `commit replacement-path route`: `0xfe73694b73092f43f5430ee17a78363cc5910a6a38768c1554557750d02e9f27`
  - `mark replacement-path delivered`: `0x0a835b778c0edc962e0eaf87a0b8b28b510123c5aa675ea3b28aa796e4cf384f`
  - `open replacement-path claim`: `0xcea0cd37e0682736767c107131b1ec110f8e0a7c9768874023393ab855cfee0d`
  - `revoke original arbiter`: `0x2fede5fc8e24415282c1af9449abf85f8de9e5b7e7fdc4edf3be42a7534541b9`
  - `buyer proposes replacement arbiter`: `0xed0fdd01d9558dbb0d68fb35a9aca2a70655119988fc54752a63977c4a0a5b3b`
  - `replacement arbiter accepts emergency handoff`: `0x4d9a1927763d317835b8e58f03ff09859f4199e8c4cdb37e1191823134a74936`
  - `replacement arbiter resolves claim`: `0x9a4ebb1b0f5ecb4893a3d2d6d54bc88155c6eb852cb92a36bd8cc341bdbf096b`
- Anchored packets:
