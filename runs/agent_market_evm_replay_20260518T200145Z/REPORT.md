# Agent Simulation EVM Replay: agent_market_evm_replay_20260518T200145Z
...
- Transactions: `12`
- Packets: `10`; all signatures valid: `True`
...
- Packets: `12`; all signatures valid: `True`
- Observations:
  - Route failure/nonship is replayed through an arbiter-opened inspection surrogate; the contract still needs a native route-timeout claim gate.
  - Direct automated ruling is represented by a registered arbiter controller until the automated arbiter actor exists on-chain.
...
- Remedy: `{'buyer_refund_bps': 1200, 'seller_bond_penalty_bps': 0, 'type': 'partial_refund'}`
- Transactions: `13`
- Packets: `11`; all signatures valid: `True`
...
- Seller nonship and route-loss cases need a native pre-delivery route-timeout claim gate instead of the current inspection surrogate.
