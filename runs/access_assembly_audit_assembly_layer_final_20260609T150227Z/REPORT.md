# Marketplace Access-Assembly Audit: 2026-06-09T15:02:27Z
...
- Trajectory capacity: `seller_controls_ebay_account, seller_controls_shop_domain`
- Assembly placement: `none`
- Hard missing variables: `assembly_history_hash, inventory_lock_hash, item_fingerprint_hash, routeWallBundleHash, route_insurance_risk_owner_packet, route_spendability_hash, wall_bundle_hash`
- Waiver-bearing variables: `external_availability_covenant`
...
- Trajectory capacity: `seller_controls_ebay_account, seller_controls_shop_domain`
- Assembly placement: `CardReferenceCandidate, arbiter_policy_hash, bond_scope_packet, inventory_lock_hash, item_fingerprint_hash, proof_vector_scope_packet, route_insurance_risk_owner_packet, wall_bundle_hash`
- Hard missing variables: `assembly_history_hash, routeWallBundleHash, route_spendability_hash`
- Waiver-bearing variables: `none`
...
- Hard missing variables: `assembly_history_hash, routeWallBundleHash, route_spendability_hash, wall_bundle_hash`
- Waiver-bearing variables: `none`
...
- Validator agrees: `True`
- Trajectory capacity: `seller_controls_ebay_account, seller_controls_shop_domain`
- Assembly placement: `CardReferenceCandidate, arbiter_policy_hash, assembly_history_hash, bond_scope_packet, inventory_lock_hash, item_fingerprint_hash, proof_vector_scope_packet, routeWallBundleHash, route_insurance_risk_owner_packet, route_spendability_hash, wall_bundle_hash`
- Hard missing variables: `none`
- Waiver-bearing variables: `none`
