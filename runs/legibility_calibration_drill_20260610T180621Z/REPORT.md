# Legibility Calibration Drill: legibility_calibration_drill_20260610T180621Z
...
### prose trust meter in clean schema

- Expected: `blocked_prose_laundering`
- Blocked: `True`
- Errors:
  - prose aggregate language: dimensions.cost_to_fake.rationale matches '\\btrust\\s+(?:score|meter|rating)\\b'; human_summary matches '\\b\\d{1,3}\\s*/\\s*(?:10|100)\\b'; human_summary matches '\\bsafe\\s+to\\s+buy\\b'
