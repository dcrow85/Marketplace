# Agent Simulation EVM Replay: agent_market_evm_replay_20260519T003809Z
...
- Transactions: `14`
- Packets: `13`; all signatures valid: `True`
- Observations:
...
- Every replayed trade now commits a seller-signed inventory lock before route commitment.
...
- Semantically different inventory locks for the same physical card still require verifier or fingerprint scrutiny.
