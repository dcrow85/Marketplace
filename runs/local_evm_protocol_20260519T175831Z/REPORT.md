# Local EVM Protocol Probe: local_evm_protocol_20260519T175831Z
...
- Transactions:
  ...
  - `attach item evidence`: `0x64f718a8d75650dc99cecac4cd718484f8a2271f05ad380c801cc40ffccd6d61`
  - `approve verifier review scope`: `0xb87b80414d86f02ff3b30d5d504bc782907f7ac4b493addab7ec972ac3e40304`
  - `commit scoped verifier review`: `0x835808c8dcbe8abdc8e9ac2df5f1589ce92f38b859ac48d83b44bdeb40685f3e`
  - `commit item fingerprint`: `0x0d2aa026c19ec1afbec93bb0e92a42756944d28e411a423845919897b3defc2a`
  - `commit inventory lock`: `0x9f6f635ac23ed040b1aca0ce445538c917df788880355d998da10fbf10a4f3e7`
  - `commit insured route`: `0x969b4883a52a79fd3f87f74e99a9a8131a395c88c7e225c3701323249affe0f0`
  - `mark route in progress`: `0xff19ee8777c934d4504a84e62b5e42c3e6ef09064f9d2196f3d8d72ea360cf10`
  - `mark delivered`: `0xe5cc0b201fdaba64dee01d77a16c91768f36d278a7be5c2dd5506a4e64728630`
  - `buyer accepts`: `0x282f92ce10eccf743a7c2ff0226a8cb38b0130cac910a1bf613125ca6281bf56`
- Anchored packets:
  ...
  - `happy_item_evidence` `0x4dbd0f597cebc488c75c1a2469dd25b36040fbf4808ffeccd6170dc6a1b877fe` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `happy_verifier_review` `0x7fc09433283dc21878ec7c047c3938d7e7d23259ee282e3018f9ad764dac87c2` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  ...
  - `happy_route_spendability` `0x3578207feaafee710dafde7177d54eb670e976f1213d5aae63562a014b85ad46` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create new-seller trade`: `0xd2ccb5d995621bc89a8785af5f3bd6a4016f3afacc14b5004c1ced861e56b07d`
  - `seller posts larger bond`: `0x48ecfc2bb43d4b8d351b99e76212da05347def7843c5efd9c6330c5b2818eaf2`
  - `attach weak proof`: `0xbe8af1feda5411a5ae77937f6bbc994300dfe22b5a206f13063bfad419621d6a`
  - `accept claim seller predicate hash`: `0xaa14a479fd56e065b866c2a8a15576a4394e3e9fc316bdd0d7fa089e475e29e1`
  - `attach seller activity predicate`: `0xfe56dae9ade5c72f5cfcba70fef8eecbbe04ddedf6b246454581fcc205e9cc04`
  - `attach circuit profile hook`: `0x79a4351b9fc7240cc2385f212221b7a50d26404cb41001d2dd7227f60a035460`
  - `approve claim verifier scope`: `0x0816fbe378d529a06245e0f5caaca6b4bf3ee22cb86750a01ec82ffc44260572`
  - `attach sparse evidence`: `0x908948d34d94052205eb1f3b250a287c8352c15021e7c90b129cfa22788052c4`
  - `commit claim item fingerprint`: `0x6149da535f7579c14f6c2ee42f7d91321882de4d1632f33e7b975677df859626`
  - `commit claim inventory lock`: `0xb446a7b8cffc52e7a3d729b93c2be62825ff155f13079752d4a3a4af2b0aa0dc`
  - `open fingerprint challenge`: `0xa6a2b1548a2f54c27cff125f48aeec99ac6a5ec07454135b2b0f285b19255c12`
  - `clear fingerprint challenge`: `0xe9909b3993fc9e748ec6359bff6de4d6f6c05d96661af0699d3b55d73cae15d1`
  - `commit uninsured route`: `0xaf3c98a06abe3035ad65740bed10387e9875998a51508c6e8e01fbb3787a6892`
  - `mark delivered`: `0x65d6c759ae7e0e70e6117a419ecc47a53cf2ae30ab1088004335e4571e19ceba`
  - `attach received-item claim evidence`: `0x6f5b1511a259eb277daf6136c2a902f774d4c69177e4e5aa5b1ce2e4eb5c68ab`
  - `commit verifier claim note`: `0x3292ba2ff04b8a6e45fab4e6a7b1e0b638b8f9ec17513e9f24d2b9d4f858bf78`
  - `open claim with buyer dispute bond`: `0x1219d18022f3938cb1d747ddb4dbfb6075c6c4c6bd4a0e26c3596e0394f865a8`
  - `arbiter resolves claim`: `0xac0fa930b4f1e94ed0fd17ffff3faf87d1af4cf522b41a961d9d3b354c688630`
- Anchored packets:
  ...
  - `claim_sparse_item_evidence` `0x146c330615abd948c69815eef69eac4e4a57f9c6d54ad534bfa568c8b5b759dc` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `claim_received_item_evidence` `0x6b19558659e0da259ea37078e3e48c3f73df89461b2768212fb41465d00f490f` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `claim_verifier_note` `0x88f2bbb51a2bcb118eff2e7e17d7c92df404019ce80c04fb71fbe8a14bbb218e` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  - `claim_challenge_clearance_spendability` `0xc1fbd166db6fa9fd0c5e053e2ca2e206416d64bd5fb3517a90a9a2f854125f38` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_route_spendability` `0x0d808c2dcc506107b248ff0d48c3cd4ac61901a95b3cd33ad6939c007a2587e7` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_support_spendability` `0xa323b65a304dfe632973c73fd9066189b0ee72a96f7733022493a08917e9e1a7` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_bond_action_spendability` `0x7b954e4fc4c0360510adbe009179f9c06395fa483e5238960e780f8f1847ded8` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create replacement-path trade`: `0xb06bad6ba7edf4e7f254263d9740fd340b77a925ad320e7cbb7fd8aa164d79c6`
  - `seller posts replacement-path bond`: `0x92cf2807aa35231dc4108bad09dbb660a86ee7300afb13e4e12edd8b6dfaeeee`
  - `commit replacement-path item fingerprint`: `0xe4d912d19391dbb344ad0131811c8d9a6177ef9ed9ee9b495acff033824a3638`
  - `commit replacement-path inventory lock`: `0xaf17b0bdd4b147bd29fa8dae584f774be3a4d427ae278bbdd7a655264c43d8ae`
  - `commit replacement-path route`: `0xd933e38630675ac9d43ba1dda5526e8e1b4f42f428c3633d9ccaf9b2e7a1966a`
  - `mark replacement-path delivered`: `0xd543a0f65e5e7cdfe614361a8eeb627bbb0a2b56576aa968fd554ebfb49cde80`
  - `open replacement-path claim`: `0x46656a936947c744bb2ce6317fda8728c667b5dcb5d7e574c92aad6aed0b9944`
