# Seller Bootstrap Drill: seller_bootstrap_drill_20260612T172909Z
...
- Finality model: `contract_release_after_acceptance_or_ruling`
- Chargeback surface: `none_at_card_network_layer`
- Required seller bond: `$48.0` (`750 bps`)
- Covered failures: `nonship, wrong_item, material_misdescription, return_leg_bad_faith_if_proven`
- Not claiming: `card_is_authentic, fraud_impossible, guaranteed_offramp_liquidity, no_issuer_or_legal_intervention_risk, no_regulatory_surface, physical_card_truth, seller_is_honest`
...
- Errors:
  - zero-history seller got low bond without underwriter
...
- Required seller bond: `$288.0` (`4500 bps`)
- Covered failures: `nonship, wrong_item, material_misdescription, return_leg_bad_faith_if_proven`
- Not claiming: `card_is_authentic, fraud_impossible, guaranteed_offramp_liquidity, no_issuer_or_legal_intervention_risk, no_regulatory_surface, physical_card_truth`
- Expected to fail: `True`
- Passed: `True`

- Errors:
  - bond profile overclaims honesty

## Mutation Proofs

### remove_zero_history_low_bond_guard

- Target: evaluate_case: skip zero-history low-bond guard
- Expected detection: adversarial_underpriced_zero_history_bond loses its expected hard error
- Detected: `True`
- Failing cases:
  - `adversarial_underpriced_zero_history_bond` missing `zero-history seller got low bond without underwriter` after mutation
