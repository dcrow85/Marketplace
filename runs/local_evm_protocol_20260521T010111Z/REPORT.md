# Local EVM Protocol Probe: local_evm_protocol_20260521T010111Z
...
- Final state: `Settled`
- Transactions:
  - `create insured trade`: `0x586bf51f9dbfd7802cd45d099bf4807288825cfa7722825192988a3f58bd2f5a`
  - `seller posts bond`: `0x63c6123ee1e6445c4b065b31aed7f5a7264e348f7b192c41f6d28b3a10a3c9c4`
  - `attach trust proof`: `0xfd42f2912890725d715ed9e2bbe1c8b286750c92d9f01d81911fdb9ed2eafd2d`
  - `accept seller private predicate hash`: `0x5040b35016818f5a53de267d24ea8e5a72f8a89b9d0370ec8e57dcb9067cc7a4`
  - `attach seller private predicate`: `0xa40382e0dd3289faa0837154e88100543ce51cf10656439856bd044e0a13a8bb`
  - `accept buyer funding predicate hash`: `0x7f0208707694a4f16430d57bf2a7d8ec40603a22e0e72c76ed86c08593ee7f55`
  - `attach buyer funding predicate`: `0x3824b698153739a05e00913037e227590e9527abd12e863765ba1039f942804c`
  - `attach item evidence`: `0x75f513d69d67e25bd12445c696e4a258a0341e060adc8badc6f5121239d57415`
  - `approve verifier review scope`: `0x92e8e3b0afe6beca5a2d991bd75ca32597ca30cc05078da54b964f27d38a4164`
  - `commit scoped verifier review`: `0x6c3d159dd6208239115556329b539df45240b9616bef1b7bf00d6b20e7895c16`
  - `commit item fingerprint`: `0xae810fdd28ba8b3acc295bdabe28f19ea7e2bd67aec33da2a5dcb129eeaa7e35`
  - `commit inventory lock`: `0x14a781c2dfeba54ace0174f397344208ab1594fa25b713aaeae2083477e51cc2`
  - `commit insured route`: `0x88c104a85b005b8276f57798b64452acc133c1696946ded83d1a0d1721fcb8dd`
  - `mark route in progress`: `0x0d612a057cd839cfeeb67c9b6d86064b4de2b0cd89a78090f343ae10097af5a8`
  - `mark delivered`: `0xf69265d9fbf9512c4e4b576e458e1246e62e9a5dc3c70815bc1e623a26b6b655`
  - `buyer accepts`: `0x271ec60836be81dae83142a4b52b0f7d01bc9fb7a7a2728e57e94c9a3345fa6e`
- Anchored packets:
  ...
  - `happy_item_evidence` `0x9fb9e242a9e296a434c63cd3dc0a8fdb5dbe01e36a2f534cc46c0a6346886b4a` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `happy_verifier_review` `0x614a49ab1128ac2f69ff4eb16749fbcd81e061dff3598897a44c168205aea610` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  ...
  - `happy_route_spendability` `0x6332f50c9a414fa32e809f07f5a002ec2b4245dfab91d1cf64cc8467faafb8a9` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create new-seller trade`: `0x9cdcaa13047218dfa6182080e55020f69ac52438984f1bc188de25085e7c90e3`
  - `seller posts larger bond`: `0x6388daa59e7f73fff54ec93f576c08e28274216e577359f3e7dcccfa3abf8d3c`
  - `attach weak proof`: `0x3ebe617e117a2bea3ee7365438ded52f0ac11997959489bba428238091601b06`
  - `accept claim seller predicate hash`: `0xf8a7ef82a97e4ef85914592379321eb481b18be11400b4da3825e129f4bf1e4a`
  - `attach seller activity predicate`: `0x8b194ddc677e95856edb5c7956eb05169ed0217505f8feec55974c3a62f4706c`
  - `attach circuit profile hook`: `0x737eac5ebdcf83238b21b7636093e3dc050b06a98c0e95e0a973d8079520c947`
  - `approve claim verifier scope`: `0xea700a1acf84ec45f93592e17a0503f9cf5978b475005d7d416e807667b33d7e`
  - `attach sparse evidence`: `0x412b203cbd51ad9138a99e1d203dcff322199c85093e26440e86728dd746c60c`
  - `commit claim item fingerprint`: `0xb3dc951932e34379b56bf5f5ec88b0fab33c0f1efd7d8384d985e8999c49e79e`
  - `commit claim inventory lock`: `0x6bd88f445e20476c71e5f0270bdc83b6fc065311b98815e8a849ff030608e862`
  - `open fingerprint challenge`: `0x07851a5b58226125fab2f08d5a5383970acd22132db157672e71746e7e28655a`
  - `clear fingerprint challenge`: `0xc32e0e1c579307227dc7a5efc021a8297915a8bf5b73235b75d85b2435ac54e3`
  - `commit uninsured route`: `0x3d2bd1b7b93495bfdc91e59d13ca228b098ed0ab1d1776e85f6f868d38d8d257`
  - `mark delivered`: `0x35b3af4590773c92afffd8955ef740e1891cdf75dafca7fc52f6be8868d0031b`
  - `attach received-item claim evidence`: `0x0bcab5d94d56d2a4bd9509c546776f07ec5071f82008a80a7a1b9412f77e1d01`
  - `commit verifier claim note`: `0x3509ca4dbe223ffb530a3e995164e4d17b8b314f42a0b30353ab2d8df134db7a`
  - `open claim with buyer dispute bond`: `0x5e75d88e50dcef60a97803373b76ee2e0f1dbebccc4d4b1cd0efd4e80a043ece`
  - `arbiter resolves claim`: `0xc40baaded76f9550f07da1daa84bfbf89c6b08a651edfe9949cbdccef09d075a`
- Anchored packets:
  ...
  - `claim_sparse_item_evidence` `0x676eb2eb3319afc97fa2d67e005b867ae71c63ad111d9be4807d5801bc624825` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `claim_received_item_evidence` `0xd1f7a74b01c693d06ccf33af71160a46ea810b348fc6de4076ba0dfe7c76ed7b` (marketplace.evidence_manifest.v0.3, valid signature)
  ...
  - `claim_verifier_note` `0x3f0fbd033d0813366c622b5da088f4d09fb1afe542066f768880e4fa769d1b45` (marketplace.verifier_scope_attestation.v0.1, valid signature)
  - `claim_challenge_clearance_spendability` `0x1ecb42255d35b88646ca5b9b542c5d451669e723efff0fdd85d4b08fe782584f` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_route_spendability` `0xf1951242b306fd50d5a9837c0487f586cc772cd077fb478e30b439d9a096460f` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_support_spendability` `0xd0a20817cd855d82c79cb23cf30a505a8887f1266750d6406c58cef2a3bf2ec0` (marketplace.evidence_spendability.v0.1, valid signature)
  - `claim_bond_action_spendability` `0xa287f3e9218e8cac65ce8cd7716dac00c39368d2cdc4006b685a7be21c2fbb29` (marketplace.evidence_spendability.v0.1, valid signature)
...
- Final state: `Settled`
- Transactions:
  - `create replacement-path trade`: `0x2d61cab0a731c1f89c92261d957d827627e505dfedfec103a6e4fb077fa451c7`
  - `seller posts replacement-path bond`: `0xf91e65bebf044c24f68d04f33ce837a396fe19df5a8aa069682dda9607d92c94`
  - `attach replacement-path item evidence`: `0xe5661e3cc3327e80c68f00e703487e03e21600e81462424916e80cb50ed9fdb8`
  - `commit replacement-path item fingerprint`: `0x5685a5f0e000eebc2771e740c0645f241172276704d8def9aa0657fec4f95d30`
  - `commit replacement-path inventory lock`: `0x8dbb73ff70edc2ae3616dd2073d7616ed75b60c77cbf99a5f94c1cce6fe16753`
  - `commit replacement-path route`: `0x71052707d93d8fe4be8aa17cd005ed72fc253086e0af3fbb6b63589a058db638`
  - `mark replacement-path delivered`: `0xecd9527302585eb9f9ffe5f069c4e42d984806401b6e7e16fa06c1f48c840a37`
  - `open replacement-path claim`: `0x98b61fc5b1deede6eee0ad7971e272eb7c8a65de7035f0de17bb54dbd30d7fdd`
  - `revoke original arbiter`: `0x3a1e2666dc04f63a30f28e7f3699bdacdf33045774142bf2366e7b9c3bbc8c12`
  - `buyer proposes replacement arbiter`: `0x43c287aaa96358e823e81c41d972f9293936c1e46312f7e327af6e23dad12ce2`
  - `replacement arbiter accepts emergency handoff`: `0xb96ab50abd7ecea03984a4b723731c111809234ac5b4931382ff1bce5ff9cb4f`
  - `replacement arbiter resolves claim`: `0x7a82c056d05678ca08c5f15322daea432b388ea7d5436564267ae4f6b8ec8fe6`
- Anchored packets:
  ...
  - `replacement_item_evidence` `0xdcb74fb219bd1ec551762ac99d8e0f4114c6b42f6ed71e40fc1fdd5246d32720` (marketplace.evidence_manifest.v0.3, valid signature)
  - `replacement_route_spendability` `0xe6258d2e58ef6dd0eb69d51a0290d80caea0e15dc412b92b077e6968ed44322e` (marketplace.evidence_spendability.v0.1, valid signature)
